...
**Part of a three-piece portfolio on technical instruction:** **AirClaude** (this repo — build it) · [Engineer Agent Adoption Workshop](https://github.com/itsChanelML/engineer-agent-adoption-workshop) (teach it) · [Instructor Coaching Toolkit](https://github.com/itsChanelML/instructor-coaching-toolkit) (coach the instructor)
